import svgPaths from "./svg-ckn0oswic7";
import imgPersonalBanking from "./4a62a922e1608f0c207bb58e96ee5cfe9f973207.png";
  ...
  return (
    <div className="content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[32px] items-start not-italic relative shrink-0 text-[#eaeaee] text-[20px] w-[551px]">
      <p className="leading-[1.2] relative shrink-0 w-[571px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Get more from your savings with tiered interest rates and easy access to your funds, as long as you maintain a $2,500 balance.
      </p>
      <div className="leading-[0] min-w-full relative shrink-0 w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <ul className="list-disc">
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Open with $2,500</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Earn more with larger balances</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Unlimited transactions</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">$5/month fee if balance drops below $2,500</span>
          </li>
          <li className="ms-[30px]">
            <span className="leading-[1.6]">FDIC-insured via Insured Cash Sweep</span>
          </li>
        </ul>
      </div>
    </div>
...
function Frame10() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[42px] items-start left-[calc(25%+23px)] top-[calc(50%-0.5px)] w-[644px]">
      <Frame12 />
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[72px] text-white tracking-[-1.44px] w-[705px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Higher balances, higher earnings</p>
      </div>
      <Frame9 />
      <Frame11 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-[#606171] w-full whitespace-nowrap">
      ...
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center leading-[0] relative shrink-0 text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.3]">Simple, secure, everyday checking</p>
      </div>
    </div>
  );
}
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <div className="bg-white col-1 h-px ml-0 mt-0 row-1 w-[220px]" />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-[#606171] w-full whitespace-nowrap">
      ...
      <p className="font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] leading-[1.3] relative shrink-0 text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Long-term saving, built to grow
      </p>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] overflow-clip relative rounded-[20px] size-full" data-name="Desktop - 788">
