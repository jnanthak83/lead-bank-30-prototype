import svgPaths from "./svg-xsljaw6t2s";
import imgPersonalBanking from "./64fa4a6582fde38ab381b9dbb7ac8460152a21f0.png";
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <div className="bg-white col-1 h-px ml-0 mt-[0.87px] row-1 w-[220px]" />
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[32px] items-start not-italic relative shrink-0 text-[#eaeaee] text-[20px] w-[551px]">
      <p className="leading-[1.2] relative shrink-0 w-[522px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        For those maintaining a daily balance of $1,000+, this account offers interest and unlimited check writing—all while keeping your money working for you.
      </p>
      <div className="leading-[0] min-w-full relative shrink-0 w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <ul className="list-disc">
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Open with just $100</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Requires $1,000 daily balance to waive $7.50/month fee</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Earn interest</span>
          </li>
          <li className="ms-[30px]">
            <span className="leading-[1.6]">Includes 10 free checks/month</span>
          </li>
        </ul>
      </div>
    </div>
...
function Frame10() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[42px] items-start left-[calc(25%+23px)] top-[calc(50%-0.5px)] w-[644px]">
      <Frame12 />
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[72px] text-white tracking-[-1.44px] w-[681px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Earn interest and enjoy added perks</p>
      </div>
      <Frame9 />
      <Frame11 />
    </div>
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] overflow-clip relative rounded-[20px] size-full" data-name="Desktop - 785">
