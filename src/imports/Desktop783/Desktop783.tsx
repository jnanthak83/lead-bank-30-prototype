import svgPaths from "./svg-k2m4nw36sg";
import imgLeadCard from "./12c918142de4b304180b81c413c2280c765f2cb1.png";
import imgLeadCard1 from "./6b81bfb3106012cf611bd112c0e7422c99009f72.png";
...
function Frame6() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[42px] items-start left-[calc(50%+5px)] not-italic top-[calc(50%+0.5px)] w-[607px]">
      <div className="flex flex-col justify-end leading-[0] relative shrink-0 text-[#2b2c39] text-[72px] tracking-[-1.44px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Everyday Banking</p>
      </div>
      <p className="leading-[1.3] min-w-full relative shrink-0 text-[#606171] text-[24px] w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 783">
      <div className="absolute h-[1080px] left-0 top-0 w-[1920px]" data-name="Lead Card">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgLeadCard} />
          <img alt="" className="absolute max-w-none object-cover size-full" src={imgLeadCard1} />
        </div>
      </div>
