import svgPaths from "./svg-r7g46kr4tp";
...
function Frame8() {
  return (
    <div className="backdrop-blur-[40px] content-stretch flex flex-col gap-[24px] items-start py-[8px] relative shrink-0 w-full">
      ...
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.4] not-italic opacity-60 relative shrink-0 text-[#606171] text-[20px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>{` Your Name`}</p>
      <div className="absolute flex h-[32px] items-center justify-center left-[-2px] top-[32px] w-0" style={{ "--transform-inner-width": "300", "--transform-inner-height": "19" } as React.CSSProperties}>
          ...
          <div className="h-0 relative w-[32px]">
            <div className="absolute inset-[-2px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 2">
                <line id="Line 1" stroke="var(--stroke-0, #0040FF)" strokeWidth="2" x2="32" y1="1" y2="1" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame9() {
  return (
    <div className="backdrop-blur-[40px] content-stretch flex flex-col gap-[24px] items-start not-italic py-[8px] relative shrink-0 w-full whitespace-nowrap">
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center leading-[0] opacity-60 relative shrink-0 text-[#606171] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.2]">Email</p>
      </div>
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.4] opacity-40 relative shrink-0 text-[#2b2c39] text-[20px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Enter Your Email
      </p>
    </div>
  );
...
function Frame7() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute backdrop-blur-[40px] bg-[rgba(255,255,255,0.32)] content-stretch flex flex-col gap-[32px] items-center justify-center left-[calc(66.67%-11.5px)] px-[50px] py-[60px] rounded-[62px] top-[calc(50%+0.5px)] w-[607px]">
      <div aria-hidden="true" className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[62px]" />
      <Frame8 />
      <div className="bg-[#0040ff] h-px shrink-0 w-[507px]" />
      <Frame9 />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[42px] items-start left-[calc(8.33%+34px)] top-1/2">
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[#2b2c39] text-[72px] tracking-[-1.44px] w-[547px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Lead Bank</p>
      </div>
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[#606171] text-[24px] w-[524px]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Programmable financial services designed to help fintechs scale quickly and responsibly. `}</p>
      <div className="bg-white content-stretch flex gap-[12px] h-[48px] items-center justify-center px-[32px] py-[12px] relative rounded-[24px] shrink-0" data-name="Button">
        <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center leading-[0] not-italic relative shrink-0 text-[#2b2c39] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[1.2]">More About Us</p>
        </div>
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="arrow-right">
          <div className="absolute inset-[20.83%]" data-name="Icon">
            <div className="absolute inset-[-5.36%]">
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 779">
