import svgPaths from "./svg-dwq2xi2dmf";
import imgBaaS from "./d54437a605e1ed97e4ccad4de33f0d0fa8ac187d.png";
...
function Frame4() {
  return (
    <div className="absolute bottom-[200px] content-stretch flex flex-col gap-[52px] items-start left-[calc(8.33%+34px)] not-italic">
      ...
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-end leading-[0] relative shrink-0 text-[#2b2c39] text-[116px] tracking-[-2.32px] w-[909px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-none mb-0">Move Fast.</p>
        <p className="leading-none">Stay Compliant.</p>
      </div>
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.3] relative shrink-0 text-[#606171] text-[32px] w-[866px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Markets shift. Regulations evolve. Technologies emerge. Lead brings deep experience across compliance, finance, and technology to help you adapt, stay ahead of change, and build with confidence — no matter where the market goes.
      </p>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 600">
