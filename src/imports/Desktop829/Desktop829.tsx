import svgPaths from "./svg-mai8uxvg2i";
import imgBaaS from "./3db9fc0c0be477159022f55de368db197e277e2d.png";
  ...
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[52px] items-start left-[calc(8.33%+34px)] top-1/2">
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[#2b2c39] text-[72px] tracking-[-1.44px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Lend</p>
      </div>
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[#606171] text-[24px] w-[493px]" style={{ fontVariationSettings: "'wdth' 100" }}>Offer embedded credit products, from term loans and lines of credit to in-app financing and “Buy Now, Pay Later” options.</p>
...
export default function Desktop({ onNavigate }: { onNavigate?: (page: "lend" | "console", section?: string) => void } = {}) {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 829">
      ...
      <Frame5 onLearnMore={() => onNavigate?.("lend")} onLaunchConsole={() => onNavigate?.("console")} />
