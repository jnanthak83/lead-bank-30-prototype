import svgPaths from "./svg-j4yp3dynij";
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[60px] items-start relative shrink-0 w-full">
      <div className="flex flex-col justify-end min-w-full relative shrink-0 text-[#2b2c39] text-[0px] tracking-[-1.44px] w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="text-[72px]">
          <span className="leading-[1.1]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Who thrives with `}</span>
          <span className="bg-clip-text leading-[1.1] text-[transparent]" style={{ fontVariationSettings: "'wdth' 100", backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 786 50\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(78.6 5 -62.88 6.25 -2.1816e-14 0)\\'><stop stop-color=\\'rgba(0,64,255,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(12,56,255,1)\\' offset=\\'0.11194\\'/><stop stop-color=\\'rgba(24,48,255,1)\\' offset=\\'0.22388\\'/><stop stop-color=\\'rgba(47,32,255,1)\\' offset=\\'0.44775\\'/><stop stop-color=\\'rgba(71,16,255,1)\\' offset=\\'0.67163\\'/><stop stop-color=\\'rgba(94,0,255,1)\\' offset=\\'0.8955\\'/></radialGradient></defs></svg>'), linear-gradient(90deg, rgb(0, 64, 255) 0%, rgb(0, 64, 255) 100%)" }}>
            Lead
          </span>
        </p>
      </div>
      <ul className="block list-disc relative shrink-0 text-[#606171] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <li className="mb-0 ms-[36px]">
          <span className="leading-[1.6]">You value compliance as much as innovation.</span>
        </li>
        <li className="mb-0 ms-[36px]">
          <span className="leading-[1.6]">You’re ready to scale or launch your product responsibly.</span>
        </li>
        <li className="mb-0 ms-[36px]">
          <span className="leading-[1.6]">You bring strong technical teams or program management skills.</span>
        </li>
        <li className="mb-0 ms-[36px]">
          <span className="leading-[1.6]">You’re looking for a true partner — not a plug-and-play vendor.</span>
        </li>
        <li className="ms-[36px]">
          <span className="leading-[1.6]">You’re committed to building something that lasts.</span>
        </li>
      </ul>
    </div>
  );
...
function Frame7() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[60px] items-start leading-[0] left-[calc(8.33%+34px)] not-italic top-1/2 w-[786px]">
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center relative shrink-0 text-[#606171] text-[14px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 656">
