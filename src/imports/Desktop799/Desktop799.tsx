import svgPaths from "./svg-5vhn2basoo";
import imgBusinessBanking from "./ba1269052be0ef3b6169f294df85f06dcb6a0087.png";
  ...
  return (
    <div className="bg-[#0040ff] content-stretch flex items-center justify-center px-[20px] py-[10px] relative rounded-[30px] shrink-0">
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center leading-[0] not-italic relative shrink-0 text-[#eaeaee] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.2]">Business loans</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[32px] items-start not-italic relative shrink-0 text-[#eaeaee] text-[20px] w-[551px]">
      <p className="leading-[1.2] relative shrink-0 w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Access the capital you need to grow with confidence—whether it’s new markets, equipment, or long-term assets.
      </p>
      <div className="leading-[0] relative shrink-0 w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.6] mb-0">Loan types available:</p>
        <ul className="list-disc">
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Real estate construction loans</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Expansion term loans</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Equipment purchase loans</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Agriculture loans</span>
          </li>
          <li className="ms-[30px]">
            <span className="leading-[1.6]">Lines of credit</span>
          </li>
        </ul>
      </div>
    </div>
  ...
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[42px] items-start left-[calc(25%+23px)] top-[calc(50%+0.5px)] w-[644px]">
      ...
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[72px] text-white tracking-[-1.44px] w-[619px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Loans that work as hard as you do</p>
      </div>
      <Frame9 />
      <Frame11 />
    </div>
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] overflow-clip relative rounded-[20px] size-full" data-name="Desktop - 799">
