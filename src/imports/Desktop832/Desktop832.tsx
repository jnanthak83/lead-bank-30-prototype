...
export default function Desktop({ onNavigate }: { onNavigate?: (page: "store" | "console", section?: string) => void } = {}) {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 832">
      ...
      <Frame5 onLearnMore={() => onNavigate?.("store")} onLaunchConsole={() => onNavigate?.("console")} />
