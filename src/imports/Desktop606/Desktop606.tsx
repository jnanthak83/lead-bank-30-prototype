import svgPaths from "./svg-6ch4ibjbsi";
...
function Frame5() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[52px] items-start left-[calc(8.33%+34px)] top-1/2">
      ...
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[#606171] text-[24px] w-[493px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Easily offer term loans or lines of credit to your users. Support flexible lending models like buy-now-pay-later or fee-based products. Disburse funds directly via ACH or wire — all through one platform.
      </p>
      <Frame8 />
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 606">
