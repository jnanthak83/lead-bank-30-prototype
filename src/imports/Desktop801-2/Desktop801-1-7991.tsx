import svgPaths from "./svg-1jwmsw4lb6";
import imgBusinessBanking from "./7a79e76bb94f8858a147e3f0717fe77f9fdd2477.png";
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[32px] items-start not-italic relative shrink-0 text-[#eaeaee] text-[20px] w-[551px]">
      <p className="leading-[1.2] relative shrink-0 w-[571px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Great for businesses looking to plan ahead with guaranteed interest over a set term.
      </p>
      <div className="leading-[0] min-w-full relative shrink-0 w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.6] mb-0">Key Features:</p>
        <ul className="list-disc">
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">$2,500 to open</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Fixed interest</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Funds locked until term ends</span>
          </li>
          <li className="ms-[30px]">
            <span className="leading-[1.6]">No monthly fees</span>
          </li>
        </ul>
      </div>
    </div>
...
function Button3() {
  return (
    <div className="backdrop-blur-[20px] bg-[rgba(255,255,255,0.08)] content-stretch flex h-[48px] items-center justify-center px-[32px] py-[12px] relative rounded-[32px] shrink-0" data-name="Button">
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame10() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[42px] items-start left-[calc(25%+23px)] top-[calc(50%-0.5px)] w-[644px]">
      <Frame12 />
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[72px] text-white tracking-[-1.44px] w-[607px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Secure savings with fixed returns</p>
      </div>
      <Frame9 />
      <Frame11 />
    </div>
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-[#606171] w-full whitespace-nowrap">
      ...
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center leading-[0] relative shrink-0 text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 w-full whitespace-nowrap">
      ...
      <p className="font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] leading-[1.3] relative shrink-0 text-[#606171] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] overflow-clip relative rounded-[20px] size-full" data-name="Desktop - 801">
