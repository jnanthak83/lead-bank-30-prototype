import svgPaths from "./svg-sks3d24wao";
  ...
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[52px] items-start left-[calc(8.33%+34px)] top-1/2">
      ...
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[#606171] text-[24px] w-[450px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Power global money movement via ACH, wires, stablecoin, and internal transfers so your customers can quickly send and receive funds.
      </p>
      <Frame8 />
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 830">
