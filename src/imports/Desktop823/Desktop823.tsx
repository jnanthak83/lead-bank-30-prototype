import svgPaths from "./svg-ojel8cizif";
import imgBaaS from "./0ac67046892884161c99bd437bc06756e8e64eb1.png";
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 823">
