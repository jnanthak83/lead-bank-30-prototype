import svgPaths from "./svg-j5bxpn8fb6";
import imgPersonalBanking from "./a23905eb57d5ad35a658c4466692e8d7683f2389.png";
  ...
  return (
    <div className="bg-[#0040ff] content-stretch flex items-center justify-center px-[20px] py-[10px] relative rounded-[30px] shrink-0">
      <div className="flex flex-col font-['Lead_Sans_Variable:Medium',sans-serif] font-[493.75] justify-center leading-[0] not-italic relative shrink-0 text-[#eaeaee] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.2]">Health savings account</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[32px] items-start not-italic relative shrink-0 text-[#eaeaee] text-[20px] w-[551px]">
      <p className="leading-[1.2] relative shrink-0 w-[571px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Designed for those with high-deductible health plans. Earn interest and enjoy tax benefits while saving for medical expenses.
      </p>
      <div className="leading-[0] relative shrink-0 whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.6] mb-0">Key Features:</p>
        <ul className="list-disc">
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Withdraw anytime for qualified expenses</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Earn interest on unused funds</span>
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="leading-[1.6]">Triple tax benefit: contributions, growth, and withdrawals are tax-free</span>
          </li>
          <li className="ms-[30px]">
            <span className="leading-[1.6]">FDIC-insured</span>
          </li>
        </ul>
      </div>
    </div>
...
function Frame10() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[42px] items-start left-[calc(25%+23px)] top-[calc(50%-0.5px)] w-[644px]">
      <Frame12 />
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[72px] text-white tracking-[-1.44px] w-[626px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Tax-smart savings for healthcare</p>
      </div>
      <Frame9 />
      <Frame11 />
    </div>
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] overflow-clip relative rounded-[20px] size-full" data-name="Desktop - 791">
