import svgPaths from "./svg-e2pvf42894";
import imgBaaS from "./e500f7196e8b800b0f89f69aa152d44a61115bb5.png";

function Frame4() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[42px] items-start left-[calc(8.33%+34px)] not-italic top-[calc(50%+0.5px)]">
      <div className="flex flex-col justify-end leading-[0] relative shrink-0 text-[#2b2c39] text-[72px] tracking-[-1.44px] w-[726px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1] mb-0">Pick the pieces</p>
        <p className="leading-[1.1] mb-0">that fit. And see how</p>
        <p className="leading-[1.1]">it comes together.</p>
      </div>
      <p className="leading-[1.3] relative shrink-0 text-[#606171] text-[24px] w-[666px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Our platform gives you the building blocks — accounts, payments, cards, and lending — to design your ideal solution. Use only what you need, and leave the rest behind.
      </p>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 821">
