import svgPaths from "./svg-nop8xtzd7y";
import imgBaaS from "./b661ef6c9bc7212853f2597cd17ba4e82a261574.png";
  ...
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[52px] items-start left-[calc(8.33%+34px)] top-[calc(50%-0.5px)]">
      <div className="flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal justify-end leading-[0] not-italic relative shrink-0 text-[#2b2c39] text-[72px] tracking-[-1.44px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[1.1]">Store</p>
      </div>
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[#2b2c39] text-[24px] w-[334px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Offer FDIC-Insured Accounts to Your Customers
      </p>
      <p className="font-['Lead_Sans_Variable:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[#606171] text-[24px] w-[450px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Easily launch compliant bank accounts with flexible structures like FBO or virtual accounts. Enable payments, transfers, and deposits while simplifying financial operations and segregation of funds.
      </p>
      <Frame8 />
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 610">
