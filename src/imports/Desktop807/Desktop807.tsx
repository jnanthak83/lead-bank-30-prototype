import svgPaths from "./svg-49a252rri6";
...
import imgRectangle240652636 from "./ad222aff801d95423029cfcd0e94b9bcb4cdffa2.png";
import imgRectangle240652637 from "./53a424385ad5a584a159b81fcaaa9e41df97b493.png";
    ...
    <div className="absolute h-[21px] left-[40px] top-[45px] w-[101px]">
      <div className="absolute inset-[0_0_-54.76%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 101.001 32.4996">
          <g id="Frame 2117132317">
            <g id="Group 2117130666">
              <foreignObject height="102.888" width="110.386" x="-45.3333" y="-44.8314">
                <div style={{ backdropFilter: "blur(22.67px)", clipPath: "url(#bgblur_0_1_1271_clip_path)", height: "100%", width: "100%" }} xmlns="http://www.w3.org/1999/xhtml" />
              </foreignObject>
              ...
              <foreignObject height="102.888" width="102.951" x="-25.6175" y="-44.8314">
                <div style={{ backdropFilter: "blur(22.67px)", clipPath: "url(#bgblur_1_1_1271_clip_path)", height: "100%", width: "100%" }} xmlns="http://www.w3.org/1999/xhtml" />
              </foreignObject>
              <path d={svgPaths.p14966100} fill="var(--fill-0, #0040FF)" fillOpacity="0.6" id="Vector 134" data-figma-bg-blur-radius="45.3333" />
              <foreignObject height="102.888" width="102.951" x="-25.6175" y="-44.8314">
                <div style={{ backdropFilter: "blur(22.67px)", clipPath: "url(#bgblur_2_1_1271_clip_path)", height: "100%", width: "100%" }} xmlns="http://www.w3.org/1999/xhtml" />
              </foreignObject>
              ...
              <foreignObject height="110.446" width="102.951" x="-25.6175" y="-32.6126">
                <div style={{ backdropFilter: "blur(22.67px)", clipPath: "url(#bgblur_3_1_1271_clip_path)", height: "100%", width: "100%" }} xmlns="http://www.w3.org/1999/xhtml" />
              </foreignObject>
          ...
          <defs>
            <clipPath id="bgblur_0_1_1271_clip_path" transform="translate(45.3333 44.8314)">
              <path d={svgPaths.p3ccadc00} />
            </clipPath>
            <clipPath id="bgblur_1_1_1271_clip_path" transform="translate(25.6175 44.8314)">
              <path d={svgPaths.p14966100} />
            </clipPath>
            <clipPath id="bgblur_2_1_1271_clip_path" transform="translate(25.6175 44.8314)">
              <path d={svgPaths.p1849e200} />
            </clipPath>
            <clipPath id="bgblur_3_1_1271_clip_path" transform="translate(25.6175 32.6126)">
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[24px] items-start not-italic relative shrink-0">
      ...
      <p className="leading-[1.4] relative shrink-0 text-[#606171] text-[14px] w-[343px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Our modular infrastructure lets you integrate capabilities individually or together, so you can design flexible financial products that adapt over time.
      </p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[24px] items-start left-[40px] not-italic top-[40px]">
      <p className="leading-[1.3] relative shrink-0 text-[#2b2c39] text-[32px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Compliance at the Core
      </p>
      <p className="leading-[1.4] relative shrink-0 text-[#606171] text-[14px] w-[345px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        We combine regulatory expertise, risk management, and ongoing oversight to support responsible innovation at every stage of growth.
      </p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[24px] items-start left-[40px] not-italic top-[40px]">
      ...
      <p className="leading-[1.4] relative shrink-0 text-[#606171] text-[14px] w-[345px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Reduce complexity and risk with one partner across lending, global money movement, card issuing, and FDIC-insured accounts.
      </p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[24px] items-start left-[40px] not-italic top-[40px]">
      ...
      <p className="leading-[1.4] relative shrink-0 text-[#606171] text-[14px] w-[345px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Understanding firsthand the challenges founders face, we work closely with our partners to provide tailored support so you can scale with confidence.
      </p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-[calc(41.67%+12px)] top-[676px]">
      <div className="h-[240px] relative rounded-[52px] shrink-0 w-[452px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[52px]">
          <div className="absolute inset-0 overflow-hidden rounded-[52px]">
            <img alt="" className="absolute h-[165.33%] left-[-56.21%] max-w-none top-[-32.68%] w-[156.28%]" src={imgRectangle240652636} />
          </div>
          <div className="absolute inset-0 overflow-hidden rounded-[52px]">
            <img alt="" className="absolute h-[223.48%] left-[-105.39%] max-w-none top-[-61.93%] w-[210.96%]" src={imgRectangle240652637} />
          </div>
        </div>
      </div>
      <Group1 />
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 807">
      ...
      <Frame5 />
      <div className="absolute h-[360px] left-[calc(25%+145px)] top-[227px] w-[640px]" data-name="photo_2026-03-30 10.30.11 1" />
