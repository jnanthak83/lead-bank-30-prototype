import svgPaths from "./svg-w16to3s3fc";
import imgBaaS from "./4af10adbc12ea0f40af38b00ab7bc8c2b91c5370.png";
  ...
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col font-['Lead_Sans_Variable:Regular',sans-serif] font-normal gap-[42px] items-start left-[calc(8.33%+34px)] not-italic top-1/2">
      ...
      <p className="leading-[1.3] relative shrink-0 text-[#606171] text-[24px] w-[666px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Built from modular building blocks, Lead’s platform lets you move fast, stay compliant, and assemble exactly what your product needs — nothing more, nothing less.
      </p>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 604">
