...
export default function Desktop({ onNavigate }: { onNavigate?: (page: "move" | "console", section?: string) => void } = {}) {
  return (
    <div className="bg-[#eaeaee] relative size-full" data-name="Desktop - 830">
      ...
      <Frame5 onLearnMore={() => onNavigate?.("move")} onLaunchConsole={() => onNavigate?.("console")} />
